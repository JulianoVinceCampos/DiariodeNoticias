package br.com.julianovince.diariodenoticias.android.screens
...
import br.com.julianovince.diariodenoticias.articles.Article
...
fun ArticleScreen(
    ...
    Column{
        ...
        when {
            ...
            articles.value.error != null -> {
                articles.value.error?.let {error->
                    ErrorMessage(error)
                }
            }
            articles.value.articles.isNotEmpty() -> {
...
fun ErrorMessage(
    ...
    Box(
        ...
        Text(
            text = message,
            style = TextStyle(fontSize = 29.sp, textAlign = TextAlign.Center)
        )
    }
}